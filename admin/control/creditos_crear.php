...
$query_cantidad_facturas = mysqli_fetch_assoc(mysqli_query($db, "SELECT COUNT(id) as 'cantidad' FROM Credito;"));
...
<main id="main" class="main admin main-admin menu-toggle">
    ...
    <form method="GET" class="formulario" action="creditos_crear.php">
        <fieldset>
    ...
    <form method="POST" class="formulario" action="creditos_crear.php">
        <fieldset>
            ...
            <label for="dtCancelacion">Fecha de cancelación</label>
            <input type="date" min="<?php echo $fecha_actual; ?>" name="dtCancelacion" id="dtCancelacion" value="<?php echo $fecha_actual; ?>">

            <label for="txtTotal">Total</label>
            <input disabled type="number" name="txtTotal" id="txtTotal" value="<?php echo $total; ?>">

            <label for="cbClientes">Clientes</label>
            <select name="cbClientes" id="cbClientes">
                <option disabled selected value="">-- Seleccionar Cliente --</option>
                <?php while ($cliente = mysqli_fetch_assoc($resultado_obtener_clientes)): ?>
        ...
        <div class="alinear-derecha separar-margin">
            ...
            <a class="boton-rojo" href="creditos.php?cancelado='true'">
                <span>Cancelar</span>
            </a>
